...
// node_modules/@strapi/content-manager/dist/_chunks/index-V8MWkDSd.mjs
...
var ProtectedHistoryPage = React.lazy(
  () => import("./History-B9uJsxZl-263F6Z6Z.js").then((mod) => ({ default: mod.ProtectedHistoryPage }))
);
var routes$2 = [
  {
...
var ProtectedPreviewPage = React.lazy(
  () => import("./Preview-DRJhcaIO-IVDKFNS3.js").then((mod) => ({ default: mod.ProtectedPreviewPage }))
);
var routes$1 = [
  {
...
var ProtectedEditViewPage = (0, import_react.lazy)(
  () => import("./EditViewPage-hiwZg61J-5RAMR5XK.js").then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
var ProtectedListViewPage = (0, import_react.lazy)(
  () => import("./ListViewPage-Ca8F1NL--SK553R6K.js").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
var ProtectedListConfiguration = (0, import_react.lazy)(
  () => import("./ListConfigurationPage-CA4oi4Hj-SBIZC34V.js").then((mod) => ({
    default: mod.ProtectedListConfiguration
  }))
);
var ProtectedEditConfigurationPage = (0, import_react.lazy)(
  () => import("./EditConfigurationPage-CWao3CZ3-JRLY4FS3.js").then((mod) => ({
    default: mod.ProtectedEditConfigurationPage
  }))
);
var ProtectedComponentConfigurationPage = (0, import_react.lazy)(
  () => import("./ComponentConfigurationPage-DhwMhiRn-2QTOGOEM.js").then((mod) => ({
    default: mod.ProtectedComponentConfigurationPage
  }))
);
var NoPermissions = (0, import_react.lazy)(
  () => import("./NoPermissionsPage-iPk2lFR6-BWRTDCKQ.js").then((mod) => ({ default: mod.NoPermissions }))
);
var NoContentType = (0, import_react.lazy)(
  () => import("./NoContentTypePage-CwfnU-aN-JR3LTMEO.js").then((mod) => ({ default: mod.NoContentType }))
);
...
var DocumentStatus = ({ status = "draft", ...restProps }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime.jsx)(Status, { ...restProps, showBullet: false, size: "S", variant: statusVariant, children: (0, import_jsx_runtime.jsx)(Typography, { tag: "span", variant: "omega", fontWeight: "bold", children: formatMessage({
...
var PreviewSidePanel = ({ model, documentId, document }) => {
  ...
  return {
    ...
    content: (0, import_jsx_runtime.jsx)(Flex, { gap: 2, width: "100%", children: (0, import_jsx_runtime.jsx)(
      Button,
      {
        variant: "tertiary",
        tag: Link,
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-Bue_C6ui-VN2J2T7W.js");
        return {
          Component: Layout
        };
      },
  ...
  async registerTrads({ locales }) {
    const importedTrads = await Promise.all(
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(Object.assign({ "./translations/ar.json": () => import("./ar-CCEVvqGG-M7RUENFE.js"), "./translations/ca.json": () => import("./ca-5U32ON2v-LOENBZA7.js"), "./translations/cs.json": () => import("./cs-CM2aBUar-5XW3KVZ7.js"), "./translations/de.json": () => import("./de-C72KDNOl-2T7CBJ7A.js"), "./translations/en.json": () => import("./en-D_BMf0hT-QUWNMPGJ.js"), "./translations/es.json": () => import("./es-D34tqjMw-UX2VVL45.js"), "./translations/eu.json": () => import("./eu-CdALomew-5DP6V4XM.js"), "./translations/fr.json": () => import("./fr--pg5jUbt-PVZZZ2CE.js"), "./translations/gu.json": () => import("./gu-CNpaMDpH-SWMESS6S.js"), "./translations/hi.json": () => import("./hi-Dwvd04m3-NYSSO6UB.js"), "./translations/hu.json": () => import("./hu-CeYvaaO0-HO2E3NLW.js"), "./translations/id.json": () => import("./id-BtwA9WJT-AD3ZJZZ3.js"), "./translations/it.json": () => import("./it-BrVPqaf1-J2JQT2G2.js"), "./translations/ja.json": () => import("./ja-BHqhDq4V-6UUJILWO.js"), "./translations/ko.json": () => import("./ko-HVQRlfUI-CILR7QSO.js"), "./translations/ml.json": () => import("./ml-BihZwQit-7S6CN4NL.js"), "./translations/ms.json": () => import("./ms-m_WjyWx7-WXS5L34I.js"), "./translations/nl.json": () => import("./nl-D4R9gHx5-TP63Q57U.js"), "./translations/pl.json": () => import("./pl-sbx9mSt_-RKIK2MPD.js"), "./translations/pt-BR.json": () => import("./pt-BR-C71iDxnh-SYOXIHJL.js"), "./translations/pt.json": () => import("./pt-BsaFvS8--5X3CPYT6.js"), "./translations/ru.json": () => import("./ru-BE6A4Exp-GDT3FSJB.js"), "./translations/sa.json": () => import("./sa-Dag0k-Z8-IM4STGE3.js"), "./translations/sk.json": () => import("./sk-BFg-R8qJ-JM3BCP4F.js"), "./translations/sv.json": () => import("./sv-CUnfWGsh-3NML3JYQ.js"), "./translations/th.json": () => import("./th-BqbI8lIT-FVEECRUA.js"), "./translations/tr.json": () => import("./tr-CgeK3wJM-Y6N4WWWX.js"), "./translations/uk.json": () => import("./uk-CR-zDhAY-AVAJVGPI.js"), "./translations/vi.json": () => import("./vi-DUXIk_fw-KEF3V6QA.js"), "./translations/zh-Hans.json": () => import("./zh-Hans-BPQcRIyH-FNECIW54.js"), "./translations/zh.json": () => import("./zh-BWZspA60-BLGLN7Z2.js") }), `./translations/${locale}.json`).then(({ default: data }) => {
          return {
...
//# sourceMappingURL=chunk-CKQYX7QJ.js.map
